#metadata((
  title: "Oxide Notes",
  desc: "The hardware and software behind Oxide computers",
  homepage: false,
)) <page>
...
= Helios
#link-new-tab("GitHub", "https://github.com/oxidecomputer/helios")

TODO

= Propolis
A Rust VMM userspace for illumos bhyve (#link-new-tab("GitHub", "https://github.com/oxidecomputer/propolis")).

While other illumos distros use bhyve on both the kernel and userspace sides, Oxide only uses it for the kernel side.
 - #link-new-tab("bhyve", "https://bhyve.org/") ("beehive") is a type 2 (hosted) hypervisor / VMM. It is both a kernel module and userspace process.
...
= Holistic Boot
Oxide's sleds have very different mechanisms for booting than traditional servers (and desktops). #link-new-tab("RFC", "https://rfd.shared.oxide.computer/rfd/0241")
...
+ *Stage 0*:
 - #link-new-tab("AMD Platform Security Processor", "https://en.wikipedia.org/wiki/AMD_Platform_Security_Processor")
  - internal initialization
  - release bootstrap process (BSP)
  - loads #link-new-tab("phbl", "https://github.com/oxidecomputer/phbl") from SPI flash
 - SP selects BSU, prepares for later steps
+ *#link-new-tab("phbl", "https://github.com/oxidecomputer/phbl")* (Pico Host Boot Loader):
...
= Hubris
A lightweight kernel for embedded systems (like the *SP*). #link-new-tab("GitHub", "https://github.com/oxidecomputer/hubris") #link-new-tab("Docs", "https://hubris.oxide.computer/reference/")
...
= Crucible
#link-new-tab("GitHub", "https://github.com/oxidecomputer/crucible")

TODO

= Omicron
#link-new-tab("GitHub", "https://github.com/oxidecomputer/omicron")
