---
title: Igloo
description: A truly smart, smart home platform
started: 2025-01-01
ended: Now
lang: Rust
homepage: true
...
link:https://www.home-assistant.io/[Home Assistant] is much better alternative to these.
...
I naively started this project thinking it would take month to make a simpler link:https://www.home-assistant.io/[Home Assistant] replacement (link:/blog/igloo/v1[see V1 post]), but turns out, smart homes are trickier than they look!
...
I kept trying to make a popular and intuitive Home Assistant competitor (link:https://github.com/LiamSnow/igloo/tree/v2[see V2 branch]), but it forced the project into directions which I didn't want to go.
