---
title: Penguin
description: A Node-Based Visual Programming Language in Rust WebAssembly
started: 2025-09-05
ended: 2025-10-05
lang: Rust
links: 
  - text: GitHub
    url: https://github.com/liamsnow/penguin
  - text: Demo
    url: /projects/penguin/demo.html
homepage: true
---

++++
<a target="_blank" href="/projects/penguin/demo.html">
    <img src="/assets/post/penguin/screenshot.png">
</a>
++++
...
impl Wire {
    pub fn new<T>(parent: &DomNode<T>, id: PenguinWireID, inner: PenguinWire) -> Self {
        ...
        let border_path = dom::path()
            ...
            .stroke("transparent")
            .stroke_width((inner.type.stroke_width() + 4) as f64)
            .fill("none")
        ...
        let path = dom::path()
            ...
            .stroke(inner.type.stroke())
            .stroke_width(inner.type.stroke_width() as f64)
            .fill("none")
            .mount(&svg);
