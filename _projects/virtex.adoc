---
title: virtex
description: 815fps FPGA-based IR machine vision camera
started: 2021-04-30
ended: 2022-05-28
lang: SystemVerilog
links:
  - text: HDL
    url: https://github.com/34-Engineering/Virtex-HDL
  - text: PCBs
    url: https://github.com/34-Engineering/Virtex-PCBs
  - text: CAD
    url: https://github.com/34-Engineering/Virtex-CAD
  - text: App
    url: https://github.com/34-Engineering/Virtex-App
homepage: false
---

== Context
In FRC (link:https://www.firstinspires.org/programs/frc/[FIRST Robotics Competition]), its quite common to need to use a camera to track the position of target.
For a long time, these targets were simply retro-reflective tape.
Teams struggled with this challenge for a long time, but eventually the link:https://limelightvision.io/[LimeLight] came out, which enabled teams to easily setup vision systems.
...
++++
<img src="/assets/post/virtex/main_pcb_back.jpeg" width="51%">

<img src="/assets/post/virtex/main_pcb_front.jpeg" width="48%">

<img src="/assets/post/virtex/on.jpeg">

<img src="/assets/post/virtex/desk.jpeg">
++++
