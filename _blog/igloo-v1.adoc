---
title: Igloo V1
description: My first attempt at a smart home platform
written: 2025-03-14
updated: 2026-04-26
links: 
  - text: "GitHub (V1 Branch)"
    url: https://github.com/LiamSnow/igloo/tree/v1
homepage: false
---

When I first started /projects/igloo[Igloo], I wanted to replace https://www.home-assistant.io/[Home Assistant] with something much simpler and more reliable.
...
image::/assets/post/igloo/v1.png[Igloo V1]


== Configuration

Everything was configured in a single immutable https://github.com/ron-rs/ron[Ron] file (users, permissions, provider configs, devices, zones, UI elements, and scripts) which sounded great at first, but quickly became tedious.
